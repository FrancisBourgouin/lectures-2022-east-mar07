...
- Hard to change once the data starts to come in
- Easier to extract when data is organized
- Blueprint (map) to see how our data is organized
- To understand how the data links together
- Easier to see how tables connect, and how to access them.
- Easier to see discrepancies in source data

CONS

- Time consuming
- Can be boring
- We know better (small set don't need structure ? (no))
